...
def make_frame(root, list_for_values): #list_for_values is qsystem
    ...
    label = tk.Label(frame_for_combobox_info, text="1. CHOOSE DISTRIBUTION LAW", bg="#ccddf3", fg="#193d6c", font=('Times', 14, 'bold'))
    label.pack(fill=tk.BOTH, expand=True)  # center label in frame

    combobox = ttk.Combobox(frame_for_combobox_info, values=choices, width=28, background="#ccddf3", foreground="#193d6c", font=('Times', 14, 'bold'))
