...
def make_frame(root, options, list_for_values):
    ...
    label = tk.Label(frame, text="7. GENERATE STATISTICS FOR PROCESSORS", bg="#ccddf3", fg="#193d6c", font = ('Times', 16, 'bold'))
    label.pack(pady=20, fill=tk.BOTH, expand=True) #center label in frame

    label = tk.Label(frame, text="CHOOSE PROCESSORS", bg="#ccddf3", fg="#193d6c",
                     font=('Times', 14, 'bold'))
